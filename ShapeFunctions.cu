...
__device__ __host__ RowVectorXd ShapeFunction(double xi, double eta, unsigned char bitElementType) {
...
__device__ __host__ MatrixXd NaturalDerivatives(double xi, double eta, unsigned char bitElementType) {
...
__device__ __host__ Matrix2d Jacobian(const MatrixXd& nodeCoord, const MatrixXd& naturalDerivatives) {
//////////////////////////////////////////////////////////////////
...
__device__ __host__ Matrix2d invJacobian(const MatrixXd& nodeCoord, const MatrixXd& naturalDerivatives) {
    return Jacobian(nodeCoord,naturalDerivatives).inverse();
}

__device__ __host__ MatrixXd XYDerivatives(const MatrixXd& nodeCoord, const MatrixXd& naturalDerivatives) {
//////////////////////////////////////
...
__device__ __host__ double detJacobian(const MatrixXd& nodeCoord, const MatrixXd& naturalDerivatives) {
