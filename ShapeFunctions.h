...
Eigen::RowVectorXd ShapeFunction(double xi, double eta, unsigned char bitElementType);

Eigen::MatrixXd NaturalDerivatives(double xi, double eta, unsigned char bitElementType);
